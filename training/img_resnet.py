...
SAVE_PATH = f"resnet_img_cln.pth"
# =====================
# Dataset
# =====================
def build_df(root):
...
np.save("resnet34_test_probs_cln.npy", np.array(test_probs))
pd.DataFrame({"true": test_labels, "pred": test_preds}).to_csv("resnet34_test_preds_cln.csv", index=False)
# =====================
# TEST ROC Curve
# =====================
...
plt.ylabel("TPR")
plt.legend()
plt.savefig("test_roc_curve_resnet_cln.png")
plt.close()
...
plt.savefig("test_distribution_resnet_cln.png")
plt.close()
